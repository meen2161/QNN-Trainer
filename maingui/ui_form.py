...
class Ui_Widget(object):
    def setupUi(self, Widget):
        ...
        self.pushButton_2.setGeometry(QRect(490, 500, 211, 61))
        ...
        self.textEdit.setGeometry(QRect(320, 280, 541, 31))
        self.label_4 = QLabel(Widget)
        self.label_4.setObjectName(u"label_4")
        self.label_4.setGeometry(QRect(320, 400, 51, 20))
        self.label_4.setFont(font3)
        self.label_5 = QLabel(Widget)
        self.label_5.setObjectName(u"label_5")
        self.label_5.setGeometry(QRect(540, 350, 141, 20))
        self.label_5.setFont(font3)
        self.label_6 = QLabel(Widget)
        self.label_6.setObjectName(u"label_6")
        self.label_6.setGeometry(QRect(600, 400, 81, 20))
        self.label_6.setFont(font3)
        self.textEdit_2 = QTextEdit(Widget)
        self.textEdit_2.setObjectName(u"textEdit_2")
        self.textEdit_2.setGeometry(QRect(390, 390, 81, 31))
        self.textEdit_3 = QTextEdit(Widget)
        self.textEdit_3.setObjectName(u"textEdit_3")
        self.textEdit_3.setGeometry(QRect(690, 340, 81, 31))
        self.textEdit_4 = QTextEdit(Widget)
        self.textEdit_4.setObjectName(u"textEdit_4")
        self.textEdit_4.setGeometry(QRect(690, 390, 81, 31))
        self.label_7 = QLabel(Widget)
        self.label_7.setObjectName(u"label_7")
        self.label_7.setGeometry(QRect(340, 460, 181, 20))
        self.label_7.setFont(font3)
        self.textEdit_5 = QTextEdit(Widget)
        self.textEdit_5.setObjectName(u"textEdit_5")
        self.textEdit_5.setGeometry(QRect(530, 450, 151, 31))
        self.label_8 = QLabel(Widget)
        self.label_8.setObjectName(u"label_8")
        self.label_8.setGeometry(QRect(250, 350, 131, 20))
        self.label_8.setFont(font3)
        self.textEdit_6 = QTextEdit(Widget)
        self.textEdit_6.setObjectName(u"textEdit_6")
        self.textEdit_6.setGeometry(QRect(390, 340, 81, 31))
    ...
    def retranslateUi(self, Widget):
        ...
        self.comboBox.setItemText(0, QCoreApplication.translate("Widget", u"Simulator", None))
        self.comboBox.setItemText(1, QCoreApplication.translate("Widget", u"Real Quantum Machine", None))
        self.comboBox.setItemText(2, QCoreApplication.translate("Widget", u"Lightning qubit", None))
        self.comboBox.setItemText(3, QCoreApplication.translate("Widget", u"Qiskit aer", None))
